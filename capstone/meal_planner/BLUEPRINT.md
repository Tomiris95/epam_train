...
|--------|-------|----------|--------|------|
| EPUB — "Стол №5" medical diet cookbook | ~224 recipes | Russian | Parsed from book nutrition tables (Белки/Жиры/Углеводы) | `stol5`, `lunch`, `dinner`, `breakfast` |
| Spoonacular API | Variable (~50-150) | English | From API nutrition data | Extracted: `vegan`, `vegetarian`, `gluten_free`, `dairy_free`, `halal`, `high_protein`, etc. |
