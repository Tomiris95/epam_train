...
The system stores 124 Russian recipes from a certified medical diet cookbook (*Стол №5*) and supplements them with 100 English recipes from the Spoonacular API. All recipe search runs locally via FAISS with no cloud vector database.
